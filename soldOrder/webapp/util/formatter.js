...
toyota.ca.SoldOrder.util.formatter = {
	...
	formatErrorType: function (Code) {
		if (Code === "SO00001") {
			return "SO00001"; //"User Can only pick future dates. Display error message if the user select current date or past dates.";
		} else if (Code === "SO00002") {
			return "SO00002"; //"User should leave at least 5 days duration between from and to date. If not Display error message";
		} else if (Code === "SO00003") {
			return "SO00003"; //"The user not selected/entered all the mandatory information. Please complete all Mandatory fields";
			...
			return "SO00007"; //"Please select a row";
			...
			return "SO00009"; //"The user selected a date with less that 5 days gap from, from date";
