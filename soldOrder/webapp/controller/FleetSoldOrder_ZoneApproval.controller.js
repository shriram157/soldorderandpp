				...
				Object = {"FSOSummary_OrderType": [
{
	...
	},
	{
		...
		_approveFleetSoldRequest: function () {
			if(FSO_Z_controller.getView().byId('orderType_FSOZA').getKey()=="" || FSO_Z_controller.getView().byId('zoneapproval').getValue()=="")
			{
			...
			FSO_Z_controller.getView().getModel('mainservices').callFunction("/Approve_Fleet_Order", {
				...
				urlParameters: {
					...
					ZZORDER_TYPE: FSO_Z_controller.getView().byId('orderType_FSOZA').getKey(),
