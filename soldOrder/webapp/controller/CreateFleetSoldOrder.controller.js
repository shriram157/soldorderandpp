		...
		if (language === "FR") {
			...
			if (model && modelyear) {
				this.getView().byId('suffix_CFSO').bindItems({
					...
					{parts: [{path:'mainservices>suffix'},{path:'mainservices>option_1_desc_en'},{path:'mainservices>suffix_desc_en'}] , formatter: 'toyota.ca.SoldOrder.util.formatter.formatSuffix1'}
					template: new sap.ui.core.ListItem({
